...
const IMAGES: TransportImage[] = [
  ...
  { src: '/images/pexels-wanderer-731217.jpg', alt: 'Viajes y experiencias', aspectClassName: 'aspect-[3/4]' },
              ...
              >
                ...
                <div className="space-y-5 mt-8">
                  ...
                  <motion.p className="text-base text-gray-500 font-light leading-relaxed" variants={fadeInLeftVariants}>
                    Coordinamos la logística completa según tu necesidad: salidas educativas, deportivos, eventos, experiencias y más.
                  </motion.p>
                  <motion.p className="text-base text-gray-500 font-light leading-relaxed" variants={fadeInLeftVariants}>
