...
export default function PaquetesPage() {
  ...
  const handleDuplicate = async () => {
    ...
    try {
      ...
      await revalidateFrontPaths(['/experiencias', `/experiencia/${result.paquete.slug}`]);
        ...
        <AlertDialog open={!!deleteId} onOpenChange={() => setDeleteId(null)}>
          <AlertDialogContent className="z-[101]">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Esta accion no se puede deshacer. Se eliminara la experiencia permanentemente.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
